...
public class CulturesIniLanguageServer implements LanguageServer, LanguageClientAware {
    ...
    @Autowired
    private CulturesIniDocumentService documentService;

    @Autowired
    private ConfigurableApplicationContext applicationContext;

    @Autowired
    private me.nithanim.cultures.lsp.processor.services.WorkspaceService workspaceService;

    @Autowired
    private LanguageServerCommandService languageServerCommandService;
    ...
    public CompletableFuture<InitializeResult> initialize(InitializeParams params) {
        ...
        capabilities.setExecuteCommandProvider(new ExecuteCommandOptions(languageServerCommandService.getCommands()));
    ...
    public CompletableFuture<Object> shutdown() {
        ...
        //In some cases even the result of this method is never received because client already shut down.
        //Therefore, we just exit based on timeout because we already got the command to shutdown anyways and don't have to wait for something.
        Thread t = new Thread(() -> {
            try {
                Thread.sleep(2000);
    ...
    public WorkspaceService getWorkspaceService() {
        return new WorkspaceService() {
            ...
            public void didChangeWatchedFiles(DidChangeWatchedFilesParams params) {
                ...
                client.logMessage(new MessageParams(MessageType.Log, "Received workspace changewatchedfiles"));
            }
