...
@UtilityClass
class Util {
    public static List<? extends CulturesIniCommand> filterByCategory(List<? extends CulturesIniLine> commands, CulturesIniCategoryType cat) {
        return commands
                .stream()
    ...
    public static List<? extends CulturesIniCommand> filterByCategory(List<? extends CulturesIniLine> commands, EnumSet<CulturesIniCategoryType> cats) {
        return commands
                .stream()
                .filter(l -> l instanceof CulturesIniCommand)
                .map(l -> (CulturesIniCommand)l)
