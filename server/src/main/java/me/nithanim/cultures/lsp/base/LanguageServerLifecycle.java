...
public class LanguageServerLifecycle {
    ...
    @Bean
    public LanguageClient languageClient(@Value("${languageserver.port:9826}") int port) throws IOException {
        ...
        autowireCapableBeanFactory.autowire(CulturesIniLanguageServer.class, AutowireCapableBeanFactory.AUTOWIRE_BY_TYPE, true);
