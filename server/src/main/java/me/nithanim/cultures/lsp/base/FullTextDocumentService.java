...
abstract class FullTextDocumentService implements TextDocumentService {
    ...
    public void didOpen(DidOpenTextDocumentParams params) {
        ...
        applicationEventPublisher.publishEvent(new ClientSourceFileOpenedEvent(this, uri, params.getTextDocument().getText()));
    }
    ...
    public void didChange(DidChangeTextDocumentParams params) {
        ...
        for (TextDocumentContentChangeEvent changeEvent : params.getContentChanges()) {
            ...
            applicationEventPublisher.publishEvent(new ClientSourceFileChangedEvent(this, uri, changeEvent.getText()));
        }
    }
    ...
    public void didSave(DidSaveTextDocumentParams params) {
        ...
        applicationEventPublisher.publishEvent(new ClientSourceFileSavedEvent(this, params.getTextDocument().getUri(), params.getText()));
    }
}
