...
public class CulturesIniConstant implements CulturesIniLine {
    ...
    public CulturesIniConstant(Origin originAll, Origin originKey, Origin originValue, String name, String value) {
    ...
    public CulturesIniConstant(Origin originAll, Origin originKey, Origin originValue, String name, int value) {
        this.originAll = originAll;
        this.originKey = originKey;
        this.originValue = originValue;
        this.name = name;
